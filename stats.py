...
def stats_list(lim, span):
    ...
    sum(case when type = 0 and (ivl >= 1 OR ivl <= -86400) and (lastIvl > -86400 and lastIvl < 0) then 1 else 0 end) - sum(case when type = 0 and (lastIvl <= -86400 OR lastIvl >= 1) and ease = 1 then 1 else 0 end), /* learned */
