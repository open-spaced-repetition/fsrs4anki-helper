...
def todayStats_new(self):
    ...
    interpretation = "<h3>Interpretation</h3>" \
        + "Retention: the probability of recalling a card today. The average retention is often higher than your requested retention because it  is calculated in all cards including those undue cards. <br>" \
        + "Stability: the number of days it takes for the retention to decay from 100% to 90%. <br>" \
        + "Burden: the number of reviews needed to maintain retention. Total burden is the sum of reciprocals of all intervals, in days (aka the sum of 1/interval, like 1/I<sub>1</sub> + 1/I<sub>2</sub> + 1/I<sub>3</sub> +...+ 1/I<sub>n</sub>). <br>" \
        + "Count: the number of cards with custom data. <br>"
