...
def test_empty_map_returns_empty_list():
    ...
    config, decks = shared_config_decks.get_shared_configs_and_decks(custom_scheduler)
...
def test_different_spacing_around_equal_sign():
    ...
    config0, decks0 = shared_config_decks.get_shared_configs_and_decks(custom_scheduler0)
    ...
    config1, decks1 = shared_config_decks.get_shared_configs_and_decks(custom_scheduler1)
    ...
    config2, decks2 = shared_config_decks.get_shared_configs_and_decks(custom_scheduler2)
...
def test_odd_spacing_separating_deck_names_is_stripped():
    ...
    _, decks = shared_config_decks.get_shared_configs_and_decks(custom_scheduler)
    assert decks == [
        ["b", "c"],
        ["d", "e"],
        ["f", "g"],
