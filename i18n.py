...
i18n.add_translation("yesterday", tr.statistics_true_retention_yesterday(), locale=locale)
...
i18n.add_translation("retention", tr.statistics_true_retention_retention(), locale=locale)
